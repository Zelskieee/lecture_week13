...
<html lang="en">
  <head>
    ...
    <title>FakerPHP Demonstration</title>
  ...
  <body>
    <div class="container">
        <div class="row mt-5">
            ...
            <div class="col-2">
            <a href="" class="btn btn-danger w-100 mb-2">Dashboard</a>
            <a href="" class="btn btn-warning w-100 mb-2">Manage Students</a>
            <a href="" class="btn btn-success w-100 mb-2">Manage Teachers</a>
            </div>
